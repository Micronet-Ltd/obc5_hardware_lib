...
public class MControlTest {
    ...
    public void set_gpio_value() {
        ...
        // Set outputs to high
        int result0 = mControl.set_gpio_state(GP_OUTPUT_0,1);
        int result1 = mControl.set_gpio_state(GP_OUTPUT_1,1);
        int result2 = mControl.set_gpio_state(GP_OUTPUT_2,1);
        int result3 = mControl.set_gpio_state(GP_OUTPUT_3,1);
        ...
        assertTrue(mControl.get_gpoutput_state(GP_OUTPUT_0) == 1);
        assertTrue(mControl.get_gpoutput_state(GP_OUTPUT_1) == 1);
        assertTrue(mControl.get_gpoutput_state(GP_OUTPUT_2) == 1);
        assertTrue(mControl.get_gpoutput_state(GP_OUTPUT_3) == 1);

        // Set outputs to low
        result0 = mControl.set_gpio_state(GP_OUTPUT_0,0);
        result1 = mControl.set_gpio_state(GP_OUTPUT_1,0);
        result2 = mControl.set_gpio_state(GP_OUTPUT_2,0);
        result3 = mControl.set_gpio_state(GP_OUTPUT_3,0);
        ...
        assertTrue(mControl.get_gpoutput_state(GP_OUTPUT_0) == 0);
        assertTrue(mControl.get_gpoutput_state(GP_OUTPUT_1) == 0);
        assertTrue(mControl.get_gpoutput_state(GP_OUTPUT_2) == 0);
        assertTrue(mControl.get_gpoutput_state(GP_OUTPUT_3) == 0);
    }
    ...
    public void get_gpoutput_value(){
        ...
        // Set outputs to high
        int result0 = mControl.get_gpoutput_state(GP_OUTPUT_0);
        int result1 = mControl.get_gpoutput_state(GP_OUTPUT_1);
        int result2 = mControl.get_gpoutput_state(GP_OUTPUT_2);
        int result3 = mControl.get_gpoutput_state(GP_OUTPUT_3);
