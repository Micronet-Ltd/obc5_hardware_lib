...
Java_com_micronet_mcontrol_MControl_jniGetMCUVersion(JNIEnv *env, jobject instance) {
    uint8_t data[255];
...
Java_com_micronet_mcontrol_MControl_jniGetFPGAVersion(JNIEnv *env, jobject instance) {
...
JNIEXPORT jint JNICALL
Java_com_micronet_mcontrol_MControl_jniGetADCorGPIVoltage(JNIEnv *env, jobject instance, jint gpi_num) {
    uint32_t voltage = 0;
    int result = 0;
...
Java_com_micronet_mcontrol_MControl_jniSetLEDValue(JNIEnv *env, jobject instance, jint led, jint brightness, jint rgb) {
...
JNIEXPORT jint JNICALL
Java_com_micronet_mcontrol_MControl_jniSetGPIOStateDBG(JNIEnv *env, jobject instance, jint jgpio_num, jint jgpio_value) {
...
JNIEXPORT jint JNICALL
Java_com_micronet_mcontrol_MControl_jniGetGPIOStateDBG(JNIEnv *env, jobject instance, jint jgpio_num) {
...
JNIEXPORT void JNICALL
Java_com_micronet_mcontrol_MControl_jniSetSysPropPowerCtlShutdown(JNIEnv *env, jobject instance) {
